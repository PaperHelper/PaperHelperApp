...
struct Paper4thView: View {
    ...
    var body: some View {
        VStack{
            ...
            if let urlString = paperDict["pdf3"]{
...
struct Paper4thView_Previews: PreviewProvider {
