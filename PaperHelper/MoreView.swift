        ...
        VStack{
            ...
            List{
                ...
                NavigationLink(destination: Paper2ndView()){
                    VStack{
                        Text("MTH-IDS: A Multi-Tiered Hybrid Intrusion Detection System for Internet of Vehicles").font(.system(size: 19, weight: .semibold)).multilineTextAlignment(.center).lineLimit(1)
                            .frame(width: 350, height: 60)
                ...
                NavigationLink(destination: Paper3rdView()){
                    VStack{
                        Text("Social-IWSTCNN: A Social Interaction-Weighted Spatio-Temporal Convolutional Neural Network for Pedestrian Trajectory Prediction in Urban Traffic Scenarios").font(.system(size: 19, weight: .semibold)).multilineTextAlignment(.center).lineLimit(1)
                            .frame(width: 350, height: 60)
