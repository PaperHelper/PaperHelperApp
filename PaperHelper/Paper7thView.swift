...
struct Paper7thView: View {
    ...
    var body: some View {
        VStack{
            ...
            if let urlString = paperDict["pdf6"]{
...
struct Paper7thView_Previews: PreviewProvider {
