...
struct Paper5thView: View {
    ...
    var body: some View {
        VStack{
            ...
            if let urlString = paperDict["pdf4"]{
...
struct Paper5thView_Previews: PreviewProvider {
