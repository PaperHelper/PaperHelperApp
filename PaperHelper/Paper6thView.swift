...
struct Paper6thView: View {
    ...
    var body: some View {
        VStack{
            ...
            if let urlString = paperDict["pdf5"]{
...
struct Paper6thView_Previews: PreviewProvider {
