...
struct Paper8thView: View {
    ...
    var body: some View {
        VStack{
            ...
            if let urlString = paperDict["pdf7"]{
...
struct Paper8thView_Previews: PreviewProvider {
