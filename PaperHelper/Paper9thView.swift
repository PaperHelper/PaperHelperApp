    ...
    var body: some View {
        VStack{
            ...
            ScrollView(.vertical, showsIndicators: false) {
                Text(paperDict["summary8"] ?? "")
                    .font(.system(size: 15))
                    .frame(width: 350)
            } //end of Summary Scroll
            
            
            if let urlString = paperDict["pdf8"]{
...
struct Paper9thView_Previews: PreviewProvider {
